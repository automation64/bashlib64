...
@test "bl64_lib_error: error constants are set" {
  ...
  assert_equal $BL64_LIB_ERROR_EXPORT_EMPTY 60
  assert_equal $BL64_LIB_ERROR_EXPORT_SET 61
  assert_equal $BL64_LIB_ERROR_PRIVILEGE_IS_ROOT 62
  assert_equal $BL64_LIB_ERROR_PRIVILEGE_IS_NOT_ROOT 63
  assert_equal $BL64_LIB_ERROR_OVERWRITE_NOT_PERMITED 64
