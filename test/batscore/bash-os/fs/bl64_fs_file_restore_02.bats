...
@test "bl64_fs_file_restore: restore + result not ok + restore ok" {
  . "$TESTMANSH_TEST_BATSCORE_SETUP"

  # Create original file
  original_file_path="${TEST_SANDBOX}/original_file"
  sample="${TESTMANSH_TEST_SAMPLES}/text_01.txt"
  saved_file="${original_file_path}${BL64_FS_BACKUP_SUFFIX}"
  ...
  run bl64_fs_file_restore "$original_file_path" '22'
  assert_success
