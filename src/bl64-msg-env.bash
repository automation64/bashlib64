...
export _BL64_MSG_TXT_INVALID_FORMAT='invalid format. Please use one of BL64_MSG_FORMAT_*'
export _BL64_MSG_TXT_INVALID_OUTPUT='invalid output type. Please use one of BL64_MSG_OUTPUT_*'
export _BL64_MSG_TXT_INVALID_THEME='invalid theme. Please use one of BL64_MSG_THEME_*'
